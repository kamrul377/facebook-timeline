...
iconImage.forEach((icon) => {
    ...
    icon.src = `
https://scontent.fcla5-1.fna.fbcdn.net/v/t39.30808-1/321747396_1108177739870667_6890825980236911251_n.jpg?stp=dst-jpg_p200x200&_nc_cat=101&ccb=1-7&_nc_sid=7206a8&_nc_eui2=AeG8X83dn41o0sEIHagaPWSyMVvetrR30LkxW962tHfQuStq1KzmEXLQYeWFcJlasxPETE70AHT_rSl3mBd-R-4Q&_nc_ohc=xyre-2EczfoAX8pqv2T&_nc_ht=scontent.fcla5-1.fna&oh=00_AfB5XwKAFb-n4i2VgpCZb7vUhVTwrlwbSegnMqiuP9IOVQ&oe=64ABDE1D
`
})
            ...
            <div class="user-post-header">
              <div class="post-info">
                ...
                <div class="user-details">
                  <a class="author" href="#"> ${post.author.name}</a>
                  <span
                    >${post.time}
                    <svg
                      fill="currentColor"
